...
- **Clone your GitHub repo**
  ...
  ```bash
  git clone https://github.com/ShashiDivs/FLIPKART-PRODUCT-RECOMMENDER-SYSTEM.git
  ls
...
```bash
git config --global user.email "shashipolity@gmail.com"
git config --global user.name "ShashiDivs"
